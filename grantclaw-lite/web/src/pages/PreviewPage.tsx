...
export function PreviewPage() {
  ...
  const jsonString = JSON.stringify(draft.proposalJson);
  ...
  function downloadJson() {
    ...
    a.href = url;
    a.download = `${draft.grantId}-proposal.json`;
    a.click();
  ...
  return (
    <Card>
      ...
      <p className="mb-2 text-sm">Hash: <code>{draft.proposalHash}</code></p>
      <pre className="overflow-x-auto rounded bg-slate-100 p-3 text-xs">{JSON.stringify(draft.proposalJson, null, 2)}</pre>
